...
class App {
  ...
  constructor() {
    // get users'position
    this._getPosition(); // 把它放在constructor里的原因是因为只要有新的实例被创建，这个function就可以被执行
  ...
  _getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        // 使用 bind(this) 确保 _loadMap 方法中的 this 指向 App 的实例
  ...
  _newWorkOut(e) {
    ...
    if (type === 'cycling') {
      ...
      workout = new Cycling(coordsClicked, distance, duration, elevation);
    }
...
const app = new App(); // 把_getPosition方咋子constructor里 就不用app._getPosition()了
